...
public class ApartController {
	...
	@GetMapping("/gugun")
	public ResponseEntity<List<SiGunDongDto>> gugun(
	...
	public ResponseEntity<List<HouseInfoDto>> aptInfo(@RequestParam("dongCode") String dong ,@RequestParam("apartName") String apartName ) throws Exception {

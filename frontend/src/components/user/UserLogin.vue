        ...
        <b-card class="text-center mt-3 login-box" style="max-width: 40rem" align="center">
          <b-form class="text-left">
            ...
            <b-form-group label="아이디:" label-for="userId">
              <b-form-input id="userid" v-model="user.userId" required placeholder="아이디" @keyup.enter="confirm"></b-form-input>
            </b-form-group>
            <b-form-group label="비밀번호:" label-for="userPw">
              <b-form-input type="password" id="userpwd" v-model="user.userPw" required placeholder="비밀번호" @keyup.enter="confirm"></b-form-input>
            </b-form-group>
